...
const Dashboard = () => {
  ...
  const moderatorWidgets = [
    {
      ...
      icon: "👥",
      description:
        "Explora usuarios, establece conexiones y amplía tu red académica",
    ...
    },
    {
      ...
      icon: "📚",
      description:
        "Administra tus documentos, recursos académicos y materiales",
    ...
    },
    {
      ...
      icon: "🔗",
      description:
        "Visualiza conexiones entre usuarios y áreas de conocimiento",
  ...
  const studentWidgets = [
    ...
    },
    {
      ...
      icon: "💬",
      description:
        "Comunícate con otros usuarios y participa en conversaciones académicas",
      linkTo: "/chat",
      color: "bg-[var(--open-sea)]",
    },
    {
      ...
      icon: "🆘",
      description:
        "Crea una solicitud para recibir apoyo académico de otros usuarios",
      linkTo: "/help-request",
      color: "bg-[var(--deep-sea)]",
    },
    {
  ...
  console.log(
    "Dashboard - Selected widgets:",
    selectedWidgets.map((w) => w.title),
  );
