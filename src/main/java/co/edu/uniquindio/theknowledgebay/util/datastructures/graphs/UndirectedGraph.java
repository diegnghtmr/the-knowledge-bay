package co.edu.uniquindio.theknowledgebay.util.datastructures.graphs;

import co.edu.uniquindio.theknowledgebay.util.datastructures.nodes.Edge;
import co.edu.uniquindio.theknowledgebay.util.datastructures.nodes.GraphVertex;
import lombok.Data;
